<template>
  <div >
    <Breadcrumb :style="{margin: '10px 0'}">
        ...
        <BreadcrumbItem to="Albumlist">随笔管理</BreadcrumbItem>
...
export default {
    ...
    created(){
      if (this.$route.params.albumObj) {
        this.formValidate = this.$route.params.albumObj;
      }
      this.initTypeSelect();
    },
    methods: {
        initTypeSelect() {
            this.$http.get('/blog/tabCategory/categoryList?typeCode=album').then(function(res){
