<template>
  <div >
    <Breadcrumb :style="{margin: '10px 0'}">
        ...
        <BreadcrumbItem>资源帖管理</BreadcrumbItem>
    </Breadcrumb>
    <Card>
...
export default {
    ...
    methods: {
        initTable() {
            this.$http.get('/blog/tabArticle/list?pageNum='+this.current+'&pageSize='+this.pageSize+'&typeId=4'+'&searchValue='+this.searchValue).then(function(res){
